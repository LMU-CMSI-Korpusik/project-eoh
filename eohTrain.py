...
def main():
    ...
    reliable_title_wordcloud = WordCloud(width=800, height=400, background_color='white').generate(reliable_titles)
    unreliable_title_wordcloud = WordCloud(width=800, height=400, background_color='white').generate(unreliable_titles)

    # Create word clouds for reliable and unreliable article bodies
    reliable_body_wordcloud = WordCloud(width=800, height=400, background_color='white').generate(reliable_bodies)
    unreliable_body_wordcloud = WordCloud(width=800, height=400, background_color='white').generate(unreliable_bodies)
